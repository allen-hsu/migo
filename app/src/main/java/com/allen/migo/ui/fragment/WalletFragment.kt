...
class WalletFragment : BaseFragment() {
    ...
    override fun init(view: View) {
        ...
        val adapter = ArrayAdapter<PassType>(this.requireContext(), android.R.layout.simple_spinner_dropdown_item, passTypeArray)
        ...
        view.edit_pass_number.doOnTextChanged { text, start, before, count ->
            view.btn_add_pass.isEnabled = checkPassNumValid(text.toString())
        }
    }
